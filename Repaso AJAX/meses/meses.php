...
if ($_GET['num'] == 9)
  echo "<strong>Septiembre </strong>procede de <em>septem</em>, es decir, siete porque era el s�ptimo mes cuando, como he comentado, el a�o empezaba en marzo. ERES LO MEJOR QUE ME HA PASADO EN LA VIDA";
if ($_GET['num'] == 10)
